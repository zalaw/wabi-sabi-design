<template>
  <div class="projects-container-component">
    <FullScreenImageVue v-if="imageSelectedIndex !== -1"
    ...
    <div class="projects-main-container">
      <div class="projects-heading">
        <span class="back" @click.self="$emit('handleProjectsClose')"><i class="fas fa-arrow-left"></i>Back</span>
        <h1 class="text-center">Projects</h1>
        <i v-if="loggedIn" @click="showAddProject = true" class="add-project fas fa-plus-circle"></i>
      </div>
      ...
      <div v-if="option.selected !== null" class="gallery">
        <div v-if="loggedIn" class="image-container add-new-project">
